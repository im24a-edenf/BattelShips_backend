...
import com.example.springtemplate.security.auth.AuthenticationService;
 ...
 *   <li>AuthenticationManager loads User from database (via {@link com.example.springtemplate.user.UserRepository})</li>
