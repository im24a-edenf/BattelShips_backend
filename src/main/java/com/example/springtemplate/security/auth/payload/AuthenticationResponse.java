package com.example.springtemplate.security.auth.payload;

import com.example.springtemplate.security.Role;
import com.example.springtemplate.security.auth.AuthenticationController;
 ...
 * @see com.example.springtemplate.security.jwt.JwtService - Generates JWT tokens
 */
@Data
@Builder
@NoArgsConstructor
...
public class AuthenticationResponse {
     ...
     *       with its associated {@link com.example.springtemplate.security.Privilege} set</li>
     *   <li>Examples:
     *       <ul>
     ...
     * </ul>
     *
     * @see com.example.springtemplate.security.Role - Enum mapping roles to privileges
     * @see com.example.springtemplate.security.Privilege - Fine-grained permission enumeration
     */
     ...
     * </ul>
     *
     * @see com.example.springtemplate.security.jwt.JwtService - Generates and validates tokens
     * @see com.example.springtemplate.security.config.JwtAuthenticationFilter - Extracts and validates token from request
     */
